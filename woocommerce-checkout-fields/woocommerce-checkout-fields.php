...
if(is_woocommerce_active()) {
	...
	!defined('THWCFD_URL') && define('THWCFD_URL', get_template_directory_uri());
	!defined('THWCFD_ASSETS_URL') && define('THWCFD_ASSETS_URL', THWCFD_URL .'/woocommerce-checkout-fields/assets/');
